...
set(gui_data.handles.probe_line,'XData',pointList.pointList{1}(:,1));
set(gui_data.handles.probe_line,'ZData',pointList.pointList{1}(:,2));
set(gui_data.handles.probe_line,'YData',pointList.pointList{1}(:,3));
set(gui_data.handles.probe_ref_line,'XData',pointList.pointList{1}(:,1));
set(gui_data.handles.probe_ref_line,'YData',pointList.pointList{1}(:,3));
...
msgbox( ...
    ...
    'x : export probe coordinates to workspace and save file' ...
